...
public class RevenueManagementActivity extends AppCompatActivity {
    ...
    private void createWorkspaceFilterCard(String title, double value) {
        ...
        if (selectedWorkspaceFilter.equalsIgnoreCase(title)) {
            card.setCardBackgroundColor(Color.parseColor("#8EB69B")); // Accent Active Highlight
        } else {
        ...
        lblValue.setTextColor(selectedWorkspaceFilter.equalsIgnoreCase(title) ? Color.parseColor("#FFFFFF") : Color.parseColor("#4ADE80")); // Green UI Indicator for Revenue
